...
Runs `npm run kg:track` (in the sibling `Aperas/web` directory) for whatever `artifacts/*.md`
...
`npm run kg:track` manually and re-commit if you want the sync retried. A staged deletion is a
