...
- [x] Archive migration meta-task doc set (this doc set) — created and tracked. Done.
- [x] `Aperas-treeview-design.md` → done: <a name='id/BlockNode:00CE07TC0G004' class='aperas-anchor aperas-id'></a> split into [design](../design/treeview.md#id/BlockNode:00CE1GW4Y8001)/[issues](../issues/treeview.md#id/BlockNode:00CE1GW638001)/[planning](../planning/treeview.md#id/BlockNode:00CE1GW7CG001)/[history](../history/treeview.md#id/BlockNode:00CE1GW8T8001)/[discussion](../discussion/treeview.md#id/BlockNode:00CE1DDF4G001) as `treeview`. Round-trip verified, cross-references upgraded, backlinks confirmed.
